...
urlpatterns = [
    path("Homepage/", chatHomepage,name ='chatHomepage'),  
    path("chat/<name>",get_or_create_chatroom,name="start_chat"),
    path('chat/room/<chatroom_name>',chatHomepage,name="chatroom"),
